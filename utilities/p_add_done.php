    ...
    <body>
        ...
        <nav align='right'>
            <ul style='list-style-type:none;'>
                <li style='display:inline-block; margin-right:15px;'><a href='plasma_view.php' style="font-size:1.3em; padding-bottom:3px;text-decoration:none;"><font color="black"><b>Home</b></font></a></li>
            </ul>
        </nav>
        <br><br><br><br>
                <h3 align='center'><font color='red'>Data is Successfully Stored</font></h3>
</body>
</html>