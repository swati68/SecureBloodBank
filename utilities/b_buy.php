        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $stmt = $con->prepare("INSERT INTO buy_blood (username,blood_grp,antigen,quantity,age,disease,hospital,doctor,presc_num,allergy,urgency) VALUES (?, ?, ?,?,?,?,?,?,?,?,?)");
            ...
            <div style="border-style:groove; height:700px; width:1000px; margin:auto; border-color:lightgrey;">
                ...
                <table align="center" border="0" style="border-collapse:collapse; width:80%; padding:50px">
                    ...
                    <tr>
                        ...
                        <td  style="text-align:center;padding:10px 20px;"><input type="number" name="quan"> &nbsp;&nbsp;mL
                        <span class="error"><font color="red"><?php echo $err2;?></font></span>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;padding:10px 20px;">Age</td>
                        <td style="text-align:center;padding:10px 20px;"><input type="number" name="age" placeholder="Enter your age" min="18" style="padding:4px 15px;" required>
