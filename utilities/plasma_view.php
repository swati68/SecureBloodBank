...
<html>
    ...
    if ($numrow > 0) {
        echo "<table align='center' border='2' style='width:50%; '>
                <tr>
                <th style='text-align:center; padding:15px 20px;'>Plasma Bank</th>
                <th style='text-align:center; padding:15px 20px;'>Quantity Available</th>

                </tr>";
        while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
            echo "<tr><td style='text-align:center; padding:15px 20px;'>".$row['bank_name']."</td>
                        <td style='text-align:center; padding:15px 20px;'> " .$row['quantity']. "</td>
                        </tr>";
                    }
            echo "</table>";
      } 
      ...
      <a href='http://localhost/ISAA_project/data_add_plasma.php'><button style='padding:5px 10px; font-size:1.1em;'>Add Data in Plasma Bank</button></a>
</div>";
    ?>